...
import { RiCalendarEventLine, RiChat4Line, RiCreativeCommonsByLine, RiHandbagLine, RiHome3Line, RiHome4Fill, RiHomeLine, RiLogoutBoxLine, RiNotificationBadgeLine, RiUserSettingsLine, RiVirusLine } from "@remixicon/react"
...
function Sidebar() {
  ...
  return (
    <div className="w-1/6 py-10    border-black max-sm:hidden font-[joan]">

      <div className="sidebaroptions w-48 left-7 fixed top-36 bg-opacity-10 rounded-lg py-10 pl-2  ">
      

        <div className="">
        <button className="w-full text-lg   active:bg-stone-400   transition-colors  hover:bg-stone-100  mb-2 "> <div className="flex px-2">
         <div className="w-1/4 "> <RiHome3Line size={24} color="" className="opacity-60" />  </div> <div className="3/4"> <h1>Home</h1> </div>
            </div> </button>
         ...
         <div className="w-1/4 "> <RiChat4Line size={24} color="" className="opacity-60" />  </div> <div className="3/4"> <h1>Messages</h1> </div>
            ...
            <button className="w-full text-lg   active:bg-stone-400   transition-colors  hover:bg-stone-100  mb-8 "> <div className="flex px-2">
